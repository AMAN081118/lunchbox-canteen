      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            {/* <div className="text-3xl sm:text-5xl font-extrabold tracking-tighter bg-linear-to-r from-primary-600 to-accent-orange bg-clip-text text-transparent group-hover:from-primary-700 group-hover:to-accent-orange transition-all">
              LunchBox
            </div> */}
            <h3 className="text-3xl sm:text-5xl font-extrabold text-[#CB202D] tracking-tight">
              LunchBox
            </h3>
          </Link>
